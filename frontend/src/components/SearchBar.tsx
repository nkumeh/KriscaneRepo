...
const SearchBar = () => {
  ...
  const [guestCount, setAdultCount] = useState<number>(search.guestCount);
  ...
  return (
    <form
      ...
      className="-mt-8 p-3 bg-orange-800 rounded shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4"
    >
